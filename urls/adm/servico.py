...
def incluir():
    ...
    return render_template(
        "adm/serv/incluir.html", msg="", css_msg="", lst_setores=lst_setores
    )
...
def salvar_incluir():
    ...
    return render_template(
        "adm/serv/incluir.html", msg=msg, css_msg=css_msg, lst_setores=lst_setores
    )
...
def consultar():
    ...
    return render_template(
        "adm/serv/consultar.html", servicos=[], setores=setores, filtro_usado=""
    )
...
def atualizar():
    ...
    setores = dao_setor.read_by_filters([("sts_setor", "=", "A")])
    return render_template(
        "adm/serv/atualizar.html", servicos=[], setores=setores, filtro_usado=""
    )
